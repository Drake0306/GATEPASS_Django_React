...
export default function PDFRenderPaymentLedger (props) {
    ...
    useEffect(() => {
        try {
            axios.post(`${JSON_CONST.DB_URL}gatePassEntry/ledgerSearch/`, paramsData)
                .then((response) => {
    ...
    return (
        <> 
            <center style={{paddingTop: '10px'}}>
                {/* <Pdf targetRef={ref} options={options} scale={1} filename="Professional-Fee.pdf">
                    {({ toPdf }) => (
            ...
            <div style={{marginTop: '100px'}}>
                <div className="book">
                    <div className="pageLandscape" id="pageOne" ref={ref}>
                        <div className="" style={{paddingLeft: '10px', paddingRight: '10px', paddingBottom: '10px'}}>
                            <Container>
                                <Grid container alignItems="center" paddingLeft={0} paddingBottom={0} paddingRight={0} paddingTop={0} spacing={0}>
                                    <Grid item xs={4} sm={4} md={4} lg={4} className="headTitle">
                                    ...
                                    <Grid item xs={4} sm={4} md={4} lg={4} className="headTitle">
                                        ...
                                        <h6 style={{fontSize: '12px'}}>Una Terminal</h6>
                                        <h6 style={{fontSize: '12px'}}>Gaate Pass Ledger</h6>
                                    </Grid>
                                    <Grid item xs={4} sm={4} md={4} lg={4} className="headTitle">
                                        <h6 style={{fontSize: '12px'}}>From:&nbsp; {moment(paramsData.from).format('DD-MM-YYYY')}</h6>
                                    </Grid>
                                    ...
                                    <Grid item xs={12} sm={12} md={12} lg={12} mt={2} className="">
                                        <table border={1} className="tableTwo">
                                            <thead>
                                                <tr>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '30px'}}><h5>Sr</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '150px'}}><h5>Issue  Date</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '70px'}}><h5>Card No</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '70px'}}><h5>Acs Pass No</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '70px'}}><h5>Visitors Name</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '100px'}}><h5>Address</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '100px'}}><h5>Address 1</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '70px'}}><h5>Phone No</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '70px'}}><h5>ID Details</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '70px'}}><h5>Vehicle no</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '70px'}}><h5>No of person</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '70px'}}><h5>Purpose</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '70px'}}><h5>Meet With</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '70px'}}><h5>In Time</h5></th>
                                                    <th rowSpan={1} className='borderstyle' style={{width: '70px'}}><h5>Out Time</h5></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                {resData.map((row) => (
                                                    <tr key={row.id}>
                                                        ...
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'center'}}> {moment(row.date).format('DD-MM-YYYY')} </td>                                                        
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'left'}}> {row?.cardNo}{row.id}  </td>                                                        
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'left'}}> {row?.passNo}</td>                                                        
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'left'}}> {row?.name} </td>                                                        
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'left'}}> {row?.address} </td>                                                        
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'left'}}> {row?.address} </td>                                                        
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'center'}}> {row?.mobile} </td>                                                        
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'left'}}> {row?.idNo} </td>                                                        
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'center'}}> {row?.vehicleNo} </td>                                                        
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'center'}}> {row?.noOfPerson} </td>                                                        
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'left'}}> {row?.pourpose} </td>                                                        
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'left'}}> {row?.personToMeetName?.name} </td>                                                        
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'center'}}> {moment(row?.inTime).format('h:mm a')} </td>                                                        
                                                        <td className='borderstyle' style={{fontSize: '9px', textAlign: 'center'}}> {moment(row?.outTime).format('h:mm a')} </td>                                                        
                                                    </tr>
                                                    ))}
                                            </tbody>
                                        </table>
