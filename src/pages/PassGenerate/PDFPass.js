...
export default function PDFPass (props) {
    const ref = React.createRef();
    ...
    const [sizeDiv, setSizeDiv] = useState(3);
    ...
    useEffect(() => {
        try {
            axios.get(`${JSON_CONST.DB_URL}gatePassEntry/searchByID/${paramsData}`)
                .then((response) => {
                    console.log(response);
                    setResData(response.data)
                    if(response.data.allowingEntryinLicanceArea === "YES"){
                        setSizeDiv(3)
                    } else {
                        setSizeDiv(4)
                    }
    ...
    return (
        <> 
            <center style={{paddingTop: '10px'}}>
                ...
                <LoadingButton size="large" type="button" target="_blank" onClick={() => printDiv('pageOne')} variant="contained" color="error" > Generate PDF </LoadingButton>

            </center>
            <div style={{marginTop: '100px'}}>
                <div className="book">
                    <div className="pageOne" id="pageOne" ref={ref}>
                        <div className="">
                            <Grid container style={{border: '1px solid black'}} marginTop={0} alignItems="center" paddingLeft={0} paddingBottom={0} paddingRight={0} paddingTop={0} spacing={0}>
                                <Grid item xs={6} sm={6} md={6} lg={6} mt={0} className="" style={{borderRight: '1px solid black', padding: '10px'}}>
                                    <Grid container alignItems="center" paddingLeft={0} paddingBottom={0} paddingRight={0} paddingTop={0} spacing={0}>
                                        <Grid item xs={2} sm={2} md={2} lg={2} mt={0} className="">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="100" width="200" viewBox="+200.0003 -59.74475 260.0026 358.4685">
                                            ...
                                            {/* <h6> <span>( सांख्य )</span> <span style={{paddingLeft: '5px'}}>Sr No:</span> &nbsp; {resData.cardNo}{resData.id} </h6> */}
                                        </Grid>
                                        <Grid item xs={8} sm={8} md={8} lg={8} mt={-3} className="allignCenter">
                                            <h6 style={{fontSize: '14px'}}><span>इंडियन ऑयल कॉर्पोरेशन लिमिटेड</span></h6>
                                            <h5 style={{fontSize: '16.2px'}}>Indian Oil Corporation Limited</h5>
                                            <h6> <span>( ऊना टर्मिनल )</span> &nbsp;&nbsp;&nbsp;Una Terminal</h6>
                                            <h6> <span>( आगंतुक का पास )</span> <span style={{paddingLeft: '5px'}}>Visitor's Pass</span> </h6>
                                            {/* <h6 style={{paddingLeft: '5px', paddingTop: '35px'}}> <span>( तारीख )</span> <span style={{paddingLeft: '5px'}}>Date:</span> &nbsp; {moment(resData.date).format('MMMM MM, YYYY')}  </h6> */}
                                        </Grid>
                                        <Grid item xs={2} sm={2} md={2} lg={2} mt={0} className="">
                                            {/* <img src="/static/illustrations/swachhbharat-1510321257.jpg" style={{}} alt="" /> */}
                                            <h6 style={{textAlign: 'right'}}> <span>( तारीख )</span> <span style={{paddingLeft: '0px'}}>Date</span> <br />{moment(resData.date).format('DD/MM/YYYY')}  </h6> 
                                            {/* <h6> <span>( सांख्य )</span> <span style={{paddingLeft: '5px'}}>Sr No:</span> &nbsp; {resData.cardNo}{resData.id} </h6> */}
                                        </Grid>


                                        <Grid item xs={12} sm={12} md={12} lg={12} mt={0} className="allignLeft">
                                            <h6> <span>( सांख्य )</span> <span style={{paddingLeft: '5px'}}>Sr No:</span> &nbsp; {resData.cardNo}{resData.id} </h6>
                                        </Grid>
                                        <Grid item xs={12} sm={12} md={12} lg={12} mt={0} className="allignLeft">
                                            <h6> <span>( एसीएस पास संख्या )</span> <span style={{paddingLeft: '5px'}}>ACS Pass No:</span> &nbsp;{resData.passNo} </h6>
                                        </Grid>
                                        <Grid item xs={12} sm={12} md={12} lg={12} mt={0} className="allignLeft">
                                            <h6> <span>( पहचान )</span> <span style={{paddingLeft: '5px'}}>ID:</span> &nbsp; {resData.idNo}  </h6>
                                        </Grid>
                                        
                                        
                                    </Grid>
                                    <Grid container alignItems="center" paddingLeft={0} paddingBottom={0} paddingRight={0} paddingTop={0} spacing={0}>
                                        <Grid item xs={8} sm={8} md={8} lg={8} mt={0} className="">
                                        <h6> 
                                            <span>( नाम )</span> 
                                            <span style={{paddingLeft: '15px'}}>Name: </span>
                                            <span style={{paddingLeft: '34px'}}>{resData.name}</span>
                                        </h6>
                                        <h6> 
                                            <span>( कंपनी )</span> 
                                            <span style={{paddingLeft: '5px'}}>Company: </span>
                                            <span style={{paddingLeft: '18px'}}>{resData.company}</span>
                                        </h6>
                                        <div style={{display: 'flex', flexDirection: "row"}} className="allignLeft">
                                            <h6 style={{width: '15vh'}}> 
                                                <span>( पता )</span> 
                                                <span style={{paddingLeft: '16px'}}>Address</span> 
                                            </h6>
                                            <h6 style={{width: '16vh'}}> 
                                                {resData.address}
                                            </h6>
                                        ...
                                        <h6> 
                                            <span>( फ़ोन )</span> 
                                            <span style={{paddingLeft: '13px'}}>Phone: </span>
                                            <span style={{paddingLeft: '31px'}}>{resData.mobile}</span>
                                        </h6>
                                        <h6> 
                                            <span>( वाहन संख्या )</span> 
                                            <span style={{paddingLeft: '5px'}}>Vechile No: </span>
                                            <span style={{paddingLeft: '14px'}}>{resData.vehicleNo}</span>
                                        </h6>
                                        
                                        <div style={{display: 'flex', flexDirection: "column", marginTop: '5px', marginBottom: '5px'}} className="allignLeft">
                                            <h6  style={{width: '28vh'}}> 
                                                <span>( मिलने वाला व्यक्ति )</span> 
                                            </h6>
                                            <h6  style={{textAlign: 'left'}}> 
                                            <span style={{paddingLeft: '1px'}}>Person to meet :  </span>
                                            <span style={{paddingLeft: '5px'}}> <u>{resData?.personToMeet?.name}</u> </span>
                                            </h6>
                                        </div>

                                        <h6> 
                                            <span>( उद्देश्य )</span> 
                                            <span style={{paddingLeft: '5px'}}>Purpose </span>
                                            <span style={{paddingLeft: '14px'}}>{resData.pourpose}</span>
                                        </h6>
                                        <h6> 
                                            <span>( व्यक्तियों की संख्या )</span> 
                                            <span style={{paddingLeft: '5px'}}>No. of Persons: </span>
                                            <span style={{paddingLeft: '14px'}}>{resData.noOfPerson}</span>
                                        </h6>

                                        </Grid>
                                        <Grid item xs={4} sm={4} md={4} lg={4} mt={0} className="allignCenter">
                                            <img
                                                src={resData.picture}
                                                alt={`ImagePic`}
                                                loading="lazy"
                                                style={{width: '130px',height: '170px', border: '1px solid black'}}
                                            />
                                        </Grid>
                                        <Grid item xs={6} sm={6} md={6} lg={6} mt={0} className="allignLeft">
                                            <h6> 
                                                <span>( समय के भीतर )</span> 
                                                <br />
                                                <span style={{paddingLeft: '5px'}}>In Time: </span>
                                                <span style={{paddingLeft: '14px'}}>{moment(resData.inTime).format('LT')}</span>
                                            </h6>
                                        </Grid>
                                        <Grid item xs={6} sm={6} md={6} lg={6} mt={0} className="allignCenter">
                                            <h6> 
                                                <span>( बाहर जाने का समय )</span> 
                                                <br />
                                                <span style={{paddingLeft: '5px'}}>Out time: </span>
                                                <span style={{paddingLeft: '14px'}}>{resData.outTime && moment(resData.outTime).format('LT')}</span>
                                            </h6>
                                        </Grid>
                                        <Grid item xs={7} sm={7} md={7} lg={7} mt={0} className="allignCenter">
                                            <h6> 
                                                <span style={{paddingLeft: '5px'}}>Permission to enter license area </span>
                                                <br />
                                                <span style={{paddingLeft: '14px'}}>{resData.allowingEntryinLicanceArea}</span>
                                            </h6>
                                        </Grid>
                                        <Grid item xs={5} sm={5} md={5} lg={5} mt={0} className="allignCenter">
                                            <h6 style={{marginTop: '0px'}}> 
                                                <span style={{paddingLeft: '5px'}}>Permitted by </span>
                                                <br />
                                                <span style={{paddingLeft: '14px'}}> <u>{resData?.permittedByName?.name}</u> </span>
                                            </h6>
                                        </Grid>
                                        
                                        <Grid item xs={sizeDiv} sm={sizeDiv} md={sizeDiv} lg={sizeDiv} mt={0} className="allignCenter">
                                            <h6 style={{fontSize: '8px'}}> ( आगंतुक के हस्ताक्षर )</h6>
                                            <h6 style={{fontSize: '8px'}}> Signature of visitor </h6>
                                        </Grid>
                                        <Grid item xs={sizeDiv} sm={sizeDiv} md={sizeDiv} lg={sizeDiv} mt={0} className="allignCenter">
                                            <h6 style={{fontSize: '8px'}}> ( सुरक्षा गॉर्ड मेन <br />गेट के हस्ताक्षर)</h6>
                                            <h6 style={{fontSize: '8px'}}> Sign of security <br />at main gate</h6>
                                        </Grid>
                                        {resData.allowingEntryinLicanceArea && resData.allowingEntryinLicanceArea === "YES" ? (
                                            <Grid item xs={sizeDiv} sm={sizeDiv} md={sizeDiv} lg={sizeDiv} mt={0} className="allignCenter">
                                                <h6 style={{fontSize: '8px'}}> ( सुरक्षा गॉर्ड लाइसेंस <br /> गेट के हस्ताक्षर)</h6>
                                                <h6 style={{fontSize: '8px'}}> Sign of security <br />at licence area gate  </h6>
                                            </Grid>
                                        ): null}
                                        
                                        <Grid item xs={sizeDiv} sm={sizeDiv} md={sizeDiv} lg={sizeDiv} mt={0} className="allignCenter">
                                            <h6 style={{fontSize: '8px'}}> ( अधिकारी के हस्ताक्षर )</h6>
                                            <h6 style={{fontSize: '8px'}}> Signature of officer </h6>
                                        </Grid>
                                        
                                    </Grid>
                                </Grid>
                                <Grid item xs={6} sm={6} md={6} lg={6} mt={-3} className="" style={{borderleft: '1px solid black', padding: '10px'}}>
                                    <Grid container alignItems="center" paddingLeft={0} paddingBottom={0} paddingRight={0} paddingTop={0} spacing={0}>
                                        <Grid item xs={12} sm={12} md={12} lg={12} mt={0} className="allignCenter">
                                            <h6><span>( महत्वपूर्ण निर्देश )</span></h6>
                                            <h6>IMPORTANT INSTRUCTION</h6>
                                        </Grid>
                                        <Grid item xs={12} sm={12} md={12} lg={12} mt={0} className="allignLeft">
                                            <p style={{fontSize: '10px', marginTop: '8px'}}><span>* ( यह प्रतिबंधित क्षेत्र है। )</span></p>
                                            <h6>* This is a prohibted area.</h6>

                                            <p style={{fontSize: '10px', marginTop: '8px'}}><span>* ( कृपया सुरक्षा और सुरक्षा नियमों का पालन करें। )</span></p>
                                            <h6>* Kindly follow Safety and Security rules.</h6>

                                            <p style={{fontSize: '10px', marginTop: '8px'}}><span>* ( मोबाइल, माचिस, लाइटर, धूम्रपान और शस्त्र प्रतिबंधित। )</span></p>
                                            <h6>* Mobiles, Matches, Lighter, Smoking and Arms prohibited.</h6>
                                            
                                            <p style={{fontSize: '10px', marginTop: '8px'}}><span>* ( परिसर में यातायात नियमों का पालन करें। )</span></p>
                                            <h6>* Follow Traffic Rules in premises.</h6>
                                            
                                            <p style={{fontSize: '10px', marginTop: '8px'}}><span>* ( लाइसेंस प्राप्त क्षेत्र में केवल सुरक्षा जूते और हेलमेट के साथ प्रवेश की अनुमति है। )</span></p>
                                            <h6>* Entry in Licensed area is permitted only with Safety Shoes and Helmet.</h6>

                                            <p style={{fontSize: '10px', marginTop: '8px'}}><span>* ( कैमरा, फोटोग्राफी/वीडियोग्राफी पूर्णत: प्रतिबंधित है। )</span></p>
                                            <h6>* Camera, photography/videography strictly prohibited.</h6>

                                            <p style={{fontSize: '10px', marginTop: '8px'}}><span>* ( गंदगी न करें, डस्टबिन का प्रयोग करें। )</span></p>
                                            <h6>* Don't Litter, use Dust bins.</h6>

                                            <p style={{fontSize: '10px', marginTop: '8px'}}><span>* ( आपातकालीन स्थिति में मेन गेट की ओर पहुंचें और दिए गए सुरक्षा निर्देशों का पालन करें। )</span></p>
                                            <h6>* In emergency reach towards Main Gate and follow provided Safety instructions.</h6>
                                            
                                            <p style={{fontSize: '10px', marginTop: '8px'}}><span>* ( कृपया सुरक्षा में सहयोग करें। )</span></p>
                                            <h6>Kindly Cooperate with Security.</h6>
